...
public enum TextContents {
    ...
    RECOGNISE_DOCUMENT_TEXT("Unfortunately our image recognition system type 'EyeBallsSearch' is pretty busy that time," +
            "could you please helps us to identify which document is it?");
